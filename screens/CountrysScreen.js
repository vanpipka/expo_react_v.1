...
const API = Urls.SERVER_URL+Urls.COUNTRY_LIST_URL;
...
export default class LinksScreen extends React.Component {
  ...
  constructor(props) {
    ...
    this.state = {citys: [], query: navigation.getParam('country', ''), query_id: navigation.getParam('country_id', ''), dataIsLoading: false};
